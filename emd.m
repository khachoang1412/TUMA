function [x, fval] = emd(F1, F2, W1, W2, Func, p)
%
...
A = [A1; A2];
b = [W1; W2];
% equality constraints: sum of all entries of C
Aeq = ones(1, m * n);
...
[x, fval] = linprog(f, [], [], [Aeq; A], [beq; b], lb, [], [], options);
